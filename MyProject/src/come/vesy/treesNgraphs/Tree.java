 ...
 */
 class Tree<T> {
	 ...
	 */
	public static class TreeNode<T> { // Contains the value of the node 
		private T value;
...
* @param child - the child to be added. */
		 ...
		 * 
		 * @param index
		 *            - the index of the desired child. * @return the child on the given
		 *            position.
		 */
...
* representation of the parent-child relation. */
	...
	public void printDFS() {
		...
		System.out.println("The element is found " + counter + " times");
